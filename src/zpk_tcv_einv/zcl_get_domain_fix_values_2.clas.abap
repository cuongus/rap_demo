CLASS zcl_get_domain_fix_values_2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GET_DOMAIN_FIX_VALUES_2 IMPLEMENTATION.


  METHOD if_rap_query_provider~select.
    DATA business_data TYPE TABLE OF zc_domain_fix_val_2 .
    DATA business_data_line TYPE zc_domain_fix_val_2 .
