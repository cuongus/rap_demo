@AbapCatalog.sqlViewName: 'ZONETIMESUPPLIER'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'View for Onetime Supplier'
@Metadata.ignorePropagatedAnnotations: true
define root view zi_ontime_supp
  as select from I_OneTimeAccountSupplier
                                                                               ...
                                                                               and _SupplierCompany.Supplier    = $projection.Supplier
{
  ...
  key AccountingDocumentItem         as AccountingDocumentItem,
      ...
      PayeeIsAlternativePayee        as PayeeIsAlternativePayee,
